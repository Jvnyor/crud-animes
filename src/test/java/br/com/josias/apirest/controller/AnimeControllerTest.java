...
class AnimeControllerTest {
    ...
    void save_ReturnsAnime_WhenSuccessful(){
        ...
        Anime anime = animeController.createAnime(AnimePostRequestBodyCreator.createAnimePostRequestBody()).getBody();
    ...
    void replace_UpdatesAnime_WhenSuccessful(){
		...
		Assertions.assertThatCode(() -> animeController.replaceAnime(AnimePutRequestBodyCreator.createAnimePutRequestBody()))
				.doesNotThrowAnyException();
		
		ResponseEntity<Void> entity = animeController.replaceAnime(AnimePutRequestBodyCreator.createAnimePutRequestBody());
